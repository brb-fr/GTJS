...
For all platforms, run `npm install node-gyp node-addon-api && npm install brb-fr/Pogtopia growtopia.js` beforehand.
...
# Tests
Tested working on Windows and Android with Growtopia version 3.36-3.64.
